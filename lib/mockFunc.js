...
function i16(min, max) {
  const minNum = Number(min) || i16Min;
  const maxNum = Number(max) || i16Max;
  return Math.floor(Math.random() * (maxNum - minNum)) + minNum;
}

function i32(min, max) {
  const minNum = Number(min) || i32Min;
  const maxNum = Number(max) || i32Max;
  return Math.floor(Math.random() * (maxNum - minNum)) + minNum;
}
